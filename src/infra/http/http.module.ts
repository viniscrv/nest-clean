...
import { UploadAndCreateAttachmentUseCase } from "@/domain/forum/application/use-cases/upload-and-create-attachement";

@Module({
    imports: [DatabaseModule, CryptgraphyModule, StorageModule],
    controllers: [
